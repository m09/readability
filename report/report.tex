...
score function. The Negative MaxMin monoid allows us to obtain the
...
\begin{table}[H]
  ...
  \begin{tabular}{rccc}
    ...
    Negative MaxMin & $\mathbb{R}^{-} \cup \{-\infty\}$ & $\min$ & $0$ \\
  \end{tabular}
  \label{tab:monoids}
\end{table}
...
normalization would be incorrect because we do not obtain a
