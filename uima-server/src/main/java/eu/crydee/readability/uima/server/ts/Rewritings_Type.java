...
public class Rewritings_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.server.ts.Rewritings");
  ...
  public int getRewritings(int addr) {
      ...
      jcas.throwFeatMissing("rewritings", "eu.crydee.readability.uima.server.ts.Rewritings");
