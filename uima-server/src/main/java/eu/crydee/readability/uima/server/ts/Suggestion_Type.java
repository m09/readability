...
public class Suggestion_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.server.ts.Suggestion");
  ...
  public int getRevisions(int addr) {
      ...
      jcas.throwFeatMissing("revisions", "eu.crydee.readability.uima.server.ts.Suggestion");
  ...
  public Suggestion_Type(JCas jcas, Type casType) {
    ...
    casFeat_revisions = jcas.getRequiredFeatureDE(casType, "revisions", "eu.crydee.readability.uima.server.ts.Revisions", featOkTst);
