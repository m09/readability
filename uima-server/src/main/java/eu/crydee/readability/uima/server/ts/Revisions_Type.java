...
public class Revisions_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.server.ts.Revisions");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "eu.crydee.readability.uima.server.ts.Revisions");
  ...
  public int getRevisions(int addr) {
      ...
      jcas.throwFeatMissing("revisions", "eu.crydee.readability.uima.server.ts.Revisions");
