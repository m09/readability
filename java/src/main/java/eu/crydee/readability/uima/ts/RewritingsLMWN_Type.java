 ...
 * @generated */
public class RewritingsLMWN_Type extends Rewritings_Type {
  /** @generated */
  @Override
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (RewritingsLMWN_Type.this.useExistingInstance) {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.ts.RewritingsLMWN");



  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public RewritingsLMWN_Type(JCas jcas, Type casType) {
    super(jcas, casType);
