...
public class RevisedSentences_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.ts.RevisedSentences");
  ...
  public int getOriginalSentences(int addr) {
      ...
      jcas.throwFeatMissing("originalSentences", "eu.crydee.readability.uima.ts.RevisedSentences");
  ...
  public RevisedSentences_Type(JCas jcas, Type casType) {
    ...
    casFeat_originalSentences = jcas.getRequiredFeatureDE(casType, "originalSentences", "eu.crydee.readability.uima.ts.OriginalSentences", featOkTst);
