 ...
 * @generated */
public class RewritingId_Type extends Annotation_Type {
  /** @generated */
  @Override
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (RewritingId_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = RewritingId_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new RewritingId(addr, RewritingId_Type.this);
  			   RewritingId_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new RewritingId(addr, RewritingId_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = RewritingId.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.ts.RewritingId");
  ...
  public String getRevisionsId(int addr) {
      ...
      jcas.throwFeatMissing("revisionsId", "eu.crydee.readability.uima.ts.RewritingId");
  ...
  public int getRevisionsIndex(int addr) {
      ...
      jcas.throwFeatMissing("revisionsIndex", "eu.crydee.readability.uima.ts.RewritingId");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public RewritingId_Type(JCas jcas, Type casType) {
    super(jcas, casType);
