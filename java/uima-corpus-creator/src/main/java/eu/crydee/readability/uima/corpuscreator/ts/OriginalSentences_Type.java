...
public class OriginalSentences_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.corpuscreator.ts.OriginalSentences");
  ...
  public int getRevisedSentences(int addr) {
      ...
      jcas.throwFeatMissing("revisedSentences", "eu.crydee.readability.uima.corpuscreator.ts.OriginalSentences");
  ...
  public OriginalSentences_Type(JCas jcas, Type casType) {
    ...
    casFeat_revisedSentences = jcas.getRequiredFeatureDE(casType, "revisedSentences", "eu.crydee.readability.uima.corpuscreator.ts.RevisedSentences", featOkTst);
