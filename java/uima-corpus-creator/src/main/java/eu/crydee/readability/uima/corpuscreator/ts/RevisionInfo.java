...
public class RevisionInfo extends Annotation {
  ...
  public long getId() {
    if (RevisionInfo_Type.featOkTst && ((RevisionInfo_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "eu.crydee.readability.uima.corpuscreator.ts.RevisionInfo");
  ...
  public long getParentId() {
    if (RevisionInfo_Type.featOkTst && ((RevisionInfo_Type)jcasType).casFeat_parentId == null)
      jcasType.jcas.throwFeatMissing("parentId", "eu.crydee.readability.uima.corpuscreator.ts.RevisionInfo");
  ...
  public boolean getMinor() {
    if (RevisionInfo_Type.featOkTst && ((RevisionInfo_Type)jcasType).casFeat_minor == null)
      jcasType.jcas.throwFeatMissing("minor", "eu.crydee.readability.uima.corpuscreator.ts.RevisionInfo");
  ...
  public String getTimestamp() {
    if (RevisionInfo_Type.featOkTst && ((RevisionInfo_Type)jcasType).casFeat_timestamp == null)
      jcasType.jcas.throwFeatMissing("timestamp", "eu.crydee.readability.uima.corpuscreator.ts.RevisionInfo");
