...
public class OriginalWords_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.ts.OriginalWords");
  ...
  public int getRevisedWords(int addr) {
      ...
      jcas.throwFeatMissing("revisedWords", "eu.crydee.readability.uima.ts.OriginalWords");
  ...
  public OriginalWords_Type(JCas jcas, Type casType) {
    ...
    casFeat_revisedWords = jcas.getRequiredFeatureDE(casType, "revisedWords", "eu.crydee.readability.uima.ts.RevisedWords", featOkTst);
