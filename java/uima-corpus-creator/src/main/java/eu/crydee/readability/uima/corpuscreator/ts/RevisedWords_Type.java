...
public class RevisedWords_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.corpuscreator.ts.RevisedWords");
  ...
  public int getOriginalWords(int addr) {
      ...
      jcas.throwFeatMissing("originalWords", "eu.crydee.readability.uima.corpuscreator.ts.RevisedWords");
  ...
  public RevisedWords_Type(JCas jcas, Type casType) {
    ...
    casFeat_originalWords = jcas.getRequiredFeatureDE(casType, "originalWords", "eu.crydee.readability.uima.corpuscreator.ts.OriginalWords", featOkTst);
