...
public class RevisionInfo_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.corpuscreator.ts.RevisionInfo");
  ...
  public long getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "eu.crydee.readability.uima.corpuscreator.ts.RevisionInfo");
  ...
  public long getParentId(int addr) {
      ...
      jcas.throwFeatMissing("parentId", "eu.crydee.readability.uima.corpuscreator.ts.RevisionInfo");
  ...
  public boolean getMinor(int addr) {
      ...
      jcas.throwFeatMissing("minor", "eu.crydee.readability.uima.corpuscreator.ts.RevisionInfo");
  ...
  public String getTimestamp(int addr) {
      ...
      jcas.throwFeatMissing("timestamp", "eu.crydee.readability.uima.corpuscreator.ts.RevisionInfo");
