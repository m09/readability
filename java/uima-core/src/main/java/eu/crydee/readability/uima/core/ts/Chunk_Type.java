...
public class Chunk_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.core.ts.Chunk");
  ...
  public String getLabel(int addr) {
      ...
      jcas.throwFeatMissing("label", "eu.crydee.readability.uima.core.ts.Chunk");
  ...
  public int getChildren(int addr) {
      ...
      jcas.throwFeatMissing("children", "eu.crydee.readability.uima.core.ts.Chunk");
