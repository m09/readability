...
public class RewritingsByScoreThenSemiring_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.server.ts.RewritingsByScoreThenSemiring");
  ...
  public int getRewritingsByScoreThenSemiring(int addr) {
      ...
      jcas.throwFeatMissing("rewritingsByScoreThenSemiring", "eu.crydee.readability.uima.server.ts.RewritingsByScoreThenSemiring");
