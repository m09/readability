...
public class RewritingsBySemiring_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.server.ts.RewritingsBySemiring");
  ...
  public int getRewritingsBySemiring(int addr) {
      ...
      jcas.throwFeatMissing("rewritingsBySemiring", "eu.crydee.readability.uima.server.ts.RewritingsBySemiring");
