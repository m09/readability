...
public class Rewriting_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.server.ts.Rewriting");
  ...
  public int getRevisions(int addr) {
      ...
      jcas.throwFeatMissing("revisions", "eu.crydee.readability.uima.server.ts.Rewriting");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "eu.crydee.readability.uima.server.ts.Rewriting");
