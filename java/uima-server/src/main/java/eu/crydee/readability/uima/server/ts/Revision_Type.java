...
public class Revision_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("eu.crydee.readability.uima.server.ts.Revision");
  ...
  public int getTokens(int addr) {
      ...
      jcas.throwFeatMissing("tokens", "eu.crydee.readability.uima.server.ts.Revision");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "eu.crydee.readability.uima.server.ts.Revision");
  ...
  public int getCount(int addr) {
      ...
      jcas.throwFeatMissing("count", "eu.crydee.readability.uima.server.ts.Revision");
  ...
  public int getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "eu.crydee.readability.uima.server.ts.Revision");
